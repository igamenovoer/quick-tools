...
:: add-mcp-context7.bat
:: Windows batch launcher for the PowerShell helper:
::   add-mcp-context7.ps1
:: It forwards all arguments to the PowerShell script.
::
:: Note: This helper only modifies Claude Code MCP configuration
:: and does not require administrator privileges.

set "SCRIPT_DIR=%~dp0"
set "PS1_FILE=%SCRIPT_DIR%add-mcp-context7.ps1"
...
echo.
echo Running Context7 MCP server configuration helper...
echo.
